...
export default function Services() {
  ...
  const tabContent = {
    "Paid Search": {
      title: "Paid Search",
      description:
        "Your ads should do two things: be in front of the right customer and drive revenue. Our paid media campaigns are designed to maximize conversions and grow your brand.",
    },
    SEO: {
      title: "Search Engine Optimization",
      description:
