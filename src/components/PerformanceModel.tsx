        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 text-[#45AFC5] font-semibold text-base md:text-lg mt-4"
            >
          ...
          >
            {/* Top Row - Offset Left */}
            <div className="grid grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6 lg:-ml-8">
              {features.slice(0, 2).map((feature, index) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col justify-center items-center p-5">
                    {/* SVG Icon Container */}
                    <div className="w-12 h-12 md:w-14 md:h-14rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-5">
                      <img
                        src={feature.icon}
                        alt={feature.title}
                    ...
                    <motion.button
                      whileHover={{ x: 5 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center gap-2 text-white/90 font-medium text-sm md:text-base"
                    >
