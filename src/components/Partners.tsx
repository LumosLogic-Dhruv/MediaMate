          ...
          >
            {[...partners, ...partners, ...partners].map((partner, index) => (
              <motion.div
                ...
                className="flex flex-col items-center justify-center p-6 bg-white/80 backdrop-blur-sm rounded-xl shadow-md hover:shadow-lg transition-all duration-300 group cursor-pointer min-w-[160px]"
              >
                <div className="w-24 h-12 mb-3 grayscale group-hover:grayscale-0 transition-all duration-300 flex items-center justify-center">
                  <img
                    src={partner.logo}
                    alt={partner.name}
                ...
                <div className="text-sm font-medium text-gray-600 group-hover:text-gray-800 transition-colors text-center">
                  {partner.name}
                </div>
              </motion.div>
            ))}
